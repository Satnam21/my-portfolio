  ...
  return (
    <div id="projects" className="bg-gray-900 pt-[5rem] pb-[3rem]">
      ...
      <ProjectCard
        ...
        description="I am building a modern and responsive portfolio website using
      ...
      <ProjectCard
        ...
        tech3="SCSS"
        tech4="TypeScript"
        image="/images/Unionville_College.jpg"
        link="https://www.unionvillecollege.com/"
      />
      {/* <ProjectCard title="Travel Website" tech1="React js" tech2="Next js" tech3="Talwind" tech4="Typescript" image="/images/p3.png" /> */}
      <ProjectCard
        title="The Beer Store"
        description="The Beer Store is a prominent retailer and distributor of beer in Ontario, Canada, offering customers access to over 1,000 beer brands from more than 200 brewers worldwide. With a network of over 440 retail stores, The Beer Store provides a vast selection of beers to cater to diverse tastes."
        tech1="React js"
        tech2="Next js"
        tech3="Talwind"
        tech4="Typescript"
        image="/images/the-beer-store.png"
        link="https://www.thebeerstore.ca/"
      />
    </div>
  );
};
